    ...
    $(function () {
        ...
        $(".searchBtn").click(() => {
            ...
            $(document).click((event) => {
                // 클릭된 요소가 searchMenu 내부에 속해 있는지 확인
                if (!$(event.target).closest('.searchMenu').length && !$(event.target).hasClass('searchBtn')) {
                    // 클릭된 요소가 searchMenu 내부에 속해 있지 않으면 모달 닫기
                    $(".searchMenu").hide();
                }
            });
        });
        ...
        $(".myPagebtn").click(() => {
            ...
            $(document).click((event) => {
                // 클릭된 요소가 searchMenu 내부에 속해 있는지 확인
                if (!$(event.target).closest('.myPage').length && !$(event.target).hasClass('myPagebtn')) {
                    // 클릭된 요소가 searchMenu 내부에 속해 있지 않으면 모달 닫기
                    $(".myPage").hide();
                }
            });
